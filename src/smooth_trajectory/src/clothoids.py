...
if __name__ == '__main__':	
    try:
        ...
        clothoid0 = Clothoid.G1Hermite(vertices_ur_base[0,0], vertices_ur_base[1,0], 0, vertices_ur_base[0,1], vertices_ur_base[1,1], 0)
        clothoid1 = Clothoid.G1Hermite(vertices_ur_base[0,1], vertices_ur_base[1,1], 0, vertices_ur_base[0,2], vertices_ur_base[1,2], pi/2)
        clothoid2 = Clothoid.G1Hermite(vertices_ur_base[0,2], vertices_ur_base[1,2], pi/2, vertices_ur_base[0,3], vertices_ur_base[1,3], pi/2)
        clothoid3 = Clothoid.G1Hermite(vertices_ur_base[0,3], vertices_ur_base[1,3], pi, vertices_ur_base[0,4], vertices_ur_base[1,4], pi)
        clothoid4 = Clothoid.G1Hermite(vertices_ur_base[0,4], vertices_ur_base[1,4], -pi, vertices_ur_base[0,5] , vertices_ur_base[1,5], -pi/2)
        clothoid5 = Clothoid.G1Hermite(vertices_ur_base[0,5], vertices_ur_base[1,5], -pi/2, vertices_ur_base[0,6], vertices_ur_base[1,6], -pi/2)

        points = 10
        robot_x = [*clothoid0.SampleXY(points)[0], *clothoid1.SampleXY(points)[0], *clothoid2.SampleXY(points)[0], *clothoid3.SampleXY(points)[0], *clothoid4.SampleXY(points)[0], *clothoid5.SampleXY(points)[0]]
        robot_y = [*clothoid0.SampleXY(points)[1], *clothoid1.SampleXY(points)[1], *clothoid2.SampleXY(points)[1], *clothoid3.SampleXY(points)[1], *clothoid4.SampleXY(points)[1], *clothoid5.SampleXY(points)[1]]

        plt.plot(*clothoid0.SampleXY(500))
        plt.plot(*clothoid1.SampleXY(500))
        plt.plot(*clothoid2.SampleXY(500))
        plt.plot(*clothoid3.SampleXY(500))
        plt.plot(*clothoid4.SampleXY(500))
        plt.plot(*clothoid5.SampleXY(500))
        plt.plot(robot_x, robot_y)
        plt.show()

        print(len(robot_x), len(robot_y))
        ...
        path_only_vertex = []
        z_mean = np.mean(vertices_ur_base[2,:], axis=0)
        for i in range(0, len(robot_x)):
            waypoint = [robot_x[i], robot_y[i], z_mean, curr_pose[3], curr_pose[4], curr_pose[5],  velocity, acceleration, 0.0]       
            path_only_vertex.append(waypoint)
